...
export function EditorPanel({ canManage }: EditorPanelProps) {
  ...
  return (
    <section className="mb-12 rounded-3xl border border-slate-700 bg-gradient-to-br from-slate-800 via-slate-900 to-slate-950 p-6 text-white shadow-xl">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-semibold text-white">Central do Administrador / Comandante</h2>
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-2">
      <div className="rounded-2xl border border-white/10 bg-slate-800/50 p-6">
        <h3 className="text-lg font-semibold text-white">Aeronaves registradas</h3>
        <p className="mt-1 text-sm text-slate-300">
          Cadastre suas aeronaves antes de lançar voos.
        </p>
        <div className="mt-4 space-y-3 rounded-xl border border-white/10 bg-slate-900/50 p-4 text-sm text-slate-300">
          ...
          <div className="rounded-lg border border-white/10 bg-slate-800 p-3 text-xs text-slate-400">
            <p>
        ...
        <div className="mt-4 divide-y divide-white/10">
          {loading ? (
            <div className="py-4 text-sm text-slate-400">Carregando aeronaves...</div>
          ) : aircraft.length === 0 ? (
      ...
      {canManage ? (
        <form
          onSubmit={onSubmit}
          className="rounded-2xl border border-white/15 bg-slate-800/50 p-6"
        >
          <div className="flex flex-col gap-2">
            <h3 className="text-lg font-semibold text-white">Cadastrar nova aeronave</h3>
            <p className="text-sm text-slate-300">
          ...
          {requiresAddonConfirmation ? (
            <div className="mt-4 space-y-3 rounded-xl border border-amber-400/40 bg-amber-900/20 p-4 text-sm text-slate-200">
              ...
              <label className="flex items-start gap-3 rounded-lg border border-white/10 bg-slate-700 p-3 text-sm text-white">
                <input
                  id="confirmAddon"
                  type="checkbox"
                  ...
                  className="mt-1 h-4 w-4 rounded border border-white/40 bg-transparent text-amber-400 focus:ring-amber-400"
                />
                <span>
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <div>
              <label className="text-sm font-medium text-slate-300" htmlFor="tailNumber">
                Prefixo (ex: PR-AXX)
              </label>
              <input
                id="tailNumber"
                className="mt-2 w-full rounded-lg border border-white/20 bg-slate-700 px-4 py-3 text-white placeholder:text-slate-500 focus:border-amber-400 focus:outline-none focus:ring-1 focus:ring-amber-400 uppercase"
                placeholder="PR-AXX"
                {...register("tailNumber")}
              />
              {errors.tailNumber ? (
                <p className="mt-1 text-xs text-red-300">{errors.tailNumber.message}</p>
              ) : null}
            </div>
            <div>
              <label className="text-sm font-medium text-slate-300" htmlFor="model">
                Modelo
              </label>
              <input
                id="model"
                className="mt-2 w-full rounded-lg border border-white/20 bg-slate-700 px-4 py-3 text-white placeholder:text-slate-500 focus:border-amber-400 focus:outline-none focus:ring-1 focus:ring-amber-400"
                placeholder="Phenom 300"
                {...register("model")}
              />
              {errors.model ? (
                <p className="mt-1 text-xs text-red-300">{errors.model.message}</p>
              ) : null}
            </div>
            <div>
              <label className="text-sm font-medium text-slate-300" htmlFor="manufacturer">
                Fabricante (opcional)
              </label>
              <input
                id="manufacturer"
              ...
              />
              {errors.manufacturer ? (
                <p className="mt-1 text-xs text-red-300">{errors.manufacturer.message}</p>
              ) : null}
            </div>
            <div>
              ...
              />
              {errors.year ? (
                <p className="mt-1 text-xs text-red-300">{errors.year.message}</p>
              ) : null}
            </div>
            <div>
              ...
              <select
                id="status"
                className="mt-2 w-full rounded-lg border border-white/20 bg-slate-700 px-4 py-3 text-white focus:border-amber-400 focus:outline-none focus:ring-1 focus:ring-amber-400"
                {...register("status")}
              >
              ...
              {errors.status ? (
                <p className="mt-1 text-xs text-red-300">{errors.status.message}</p>
              ) : null}
            </div>
            <div>
              <label className="text-sm font-medium text-slate-300" htmlFor="nextMaintenance">
              ...
              {errors.nextMaintenance ? (
                <p className="mt-1 text-xs text-red-300">{errors.nextMaintenance.message}</p>
              ) : null}
            </div>
          </div>
          ...
          <button
            ...
            className="mt-6 w-full rounded-lg bg-amber-500 px-4 py-3 text-sm font-semibold text-slate-900 transition hover:bg-amber-400 disabled:cursor-not-allowed disabled:opacity-70"
          >
        ...
        <div className="rounded-2xl border border-white/15 bg-slate-800/50 p-6 text-sm text-slate-300">
...
function FlightManager({ flights, metadata, loading, onRefresh, canManage }: FlightManagerProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <h3 className="text-xl font-semibold text-white">Voos cadastrados</h3>
          <p className="text-sm text-slate-300">
            {canManage
        ...
        <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center">
          <div className="relative flex items-center gap-2">
            <input
              ...
              className="w-full rounded-lg border border-white/20 bg-white dark:bg-slate-700 px-4 py-2 text-sm text-white placeholder:text-slate-400 dark:placeholder:text-slate-400 focus:border-amber-400 focus:outline-none sm:w-72"
            ...
            {filterQuery ? (
              <button
                ...
                className="rounded-md border border-white/20 bg-slate-100 dark:bg-slate-700 px-2 py-1 text-xs text-slate-700 dark:text-white hover:bg-slate-200 dark:hover:bg-slate-600"
              >
                Limpar
              </button>
            ) : null}
          ...
          {canManage ? (
            <button
              ...
              className="rounded-lg bg-amber-500 px-4 py-2 text-sm font-semibold text-white dark:text-slate-900 transition hover:bg-amber-400"
            >
              + Novo voo
            </button>
          ) : (
            <span className="rounded-full border border-white/20 bg-slate-100 dark:bg-slate-700 px-4 py-2 text-xs uppercase tracking-wide text-slate-300">
              modo leitura
            </span>
          )}
        </div>
      ...
      <div className="rounded-2xl border border-white/10 bg-slate-800/50">
        <div className="flex items-center justify-between gap-3 px-4 py-3 text-xs uppercase tracking-wide text-slate-300">
          <span>
            {filterQuery
        ...
        <div className="grid grid-cols-1 divide-y divide-slate-200 dark:divide-white/5">
          {loading ? (
            <div className="p-4 text-sm text-slate-400">Carregando voos...</div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  {canManage ? (
                    <button
                      ...
                      className="rounded-lg border border-white/30 bg-white dark:bg-transparent px-3 py-2 text-sm font-semibold text-slate-700 dark:text-white transition hover:bg-slate-100 dark:hover:bg-white/10"
                    >
                      Editar
                    </button>
                  ) : null}
      ...
      {isFormOpen ? (
        <form
          onSubmit={onSubmit}
          className="rounded-2xl border border-white/15 bg-slate-800 p-6 shadow-lg"
        >
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-3 text-sm">
              <button
                ...
                className="rounded-lg border border-white/30 px-4 py-2 text-slate-700 dark:text-white transition hover:bg-slate-100 dark:hover:bg-white/10"
              >
                Cancelar
              </button>
              <button
                ...
                className="rounded-lg bg-amber-500 px-4 py-2 font-semibold text-white dark:text-slate-900 transition hover:bg-amber-400 disabled:cursor-not-allowed disabled:opacity-70"
              >
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            <div>
              <label className="text-sm font-medium text-slate-200" htmlFor="aircraftId">
                Aeronave
              </label>
              <select
                id="aircraftId"
                className="mt-2 w-full rounded-lg border border-white/20 bg-white dark:bg-slate-700 px-4 py-3 text-white focus:border-amber-400 focus:outline-none"
                {...register("aircraftId", {
            ...
            <div>
              <label className="text-sm font-medium text-slate-200" htmlFor="pilotId">
                Piloto
              </label>
              <select
                id="pilotId"
            ...
            <div>
              <label className="text-sm font-medium text-slate-200" htmlFor="flightDate">
                Data e horário
              </label>
              <input
                id="flightDate"
              ...
              />
              {errors.flightDate ? (
                <p className="mt-1 text-xs text-red-300">{errors.flightDate.message}</p>
              ) : null}
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-sm font-medium text-slate-200" htmlFor="origin">
                  Origem
                </label>
                <input
                  id="origin"
                ...
                />
                {errors.origin ? (
                  <p className="mt-1 text-xs text-red-300">{errors.origin.message}</p>
                ) : null}
              </div>
              <div>
                ...
                />
                {errors.destination ? (
                  <p className="mt-1 text-xs text-red-300">{errors.destination.message}</p>
                ) : null}
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 md:col-span-2">
              {([
                ...
                <div key={field}>
                  <label className="text-sm font-medium text-slate-200" htmlFor={field}>
                    {label}
                  </label>
                  <input
                    id={field}
                    type="number"
                    step="0.01"
                    className="mt-2 w-full rounded-lg border border-white/20 bg-white dark:bg-slate-700 px-3 py-2 text-white focus:border-amber-400 focus:outline-none"
                    {...register(field, {
                      setValueAs: optionalNumberValue,
                    })}
                  />
                  {errors[field] ? (
                    <p className="mt-1 text-xs text-red-300">{errors[field]?.message}</p>
                  ) : null}
                </div>
              ))}
              
              <div>
                <label className="text-sm font-medium text-slate-200" htmlFor="durationHours">
                ...
                <div className="mt-2 space-y-2">
                  <input
                    ...
                    type="number"
                    step="0.01"
                    className="w-full rounded-lg border border-white/20 bg-white dark:bg-slate-700 px-3 py-2 text-white focus:border-amber-400 focus:outline-none"
                  ...
                  <div className="rounded-md bg-slate-900/30 p-2">
                    <p className="text-xs text-slate-300 mb-1">Conversor Minutos → Decimais:</p>
                    <div className="flex gap-2 items-center">
                      <input
                        type="number"
                        placeholder="minutos"
                        min="0"
                        className="flex-1 rounded border border-white/10 bg-slate-800 px-2 py-1 text-sm text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:border-amber-400 focus:outline-none"
                        onChange={(e) => {
                      ...
                      />
                      <span className="text-xs text-slate-400 whitespace-nowrap">= decimais</span>
                    </div>
                  </div>
                </div>
                {errors.durationHours ? (
                  <p className="mt-1 text-xs text-red-300">{errors.durationHours.message}</p>
                ) : null}
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 md:col-span-2">
              <div>
                <label className="text-sm font-medium text-slate-200" htmlFor="baseAbsorption">
                ...
                {errors.baseAbsorption ? (
                  <p className="mt-1 text-xs text-red-300">{errors.baseAbsorption?.message}</p>
                ) : null}
              </div>
              <div>
                <label className="text-sm font-medium text-slate-200" htmlFor="baseFixedAbsorption">
                ...
                {errors.baseFixedAbsorption ? (
                  <p className="mt-1 text-xs text-red-300">{errors.baseFixedAbsorption?.message}</p>
                ) : null}
              </div>
              <div>
                <label className="text-sm font-medium text-slate-200" htmlFor="maintenanceExpenses">
                  Despesas manutenção
                </label>
                <input
                ...
                {errors.maintenanceExpenses ? (
                  <p className="mt-1 text-xs text-red-300">{errors.maintenanceExpenses?.message}</p>
                ) : null}
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 md:col-span-2">
              <div>
                <label className="text-sm font-medium text-slate-200" htmlFor="usedById">
                  Utilizado por
                </label>
                <select
                  id="usedById"
              ...
              <div>
                <label className="text-sm font-medium text-slate-200" htmlFor="baseTax">
                ...
                />
                {errors.baseTax ? (
                  <p className="mt-1 text-xs text-red-300">{errors.baseTax?.message}</p>
                ) : null}
              </div>
            </div>

            <div>
              <label className="text-sm font-medium text-slate-200" htmlFor="payerId">
            ...
            <div className="md:col-span-2">
              <label className="text-sm font-medium text-slate-200" htmlFor="attachment">
                Anexo (arquivo)
              </label>
              <div className="mt-2 space-y-2">
                <input
                  id="attachment"
                  type="file"
                  className="w-full rounded-lg border border-white/20 bg-white dark:bg-slate-700 px-4 py-3 text-white file:mr-4 file:rounded file:border-0 file:bg-blue-600 dark:file:bg-amber-500 file:px-3 file:py-2 file:text-sm file:font-semibold file:text-white dark:file:text-slate-900 hover:file:bg-blue-700 dark:hover:file:bg-amber-400"
                ...
                />
                <p className="text-xs text-slate-400">Formatos aceitos: PDF, DOC, DOCX, XLS, XLSX, JPG, PNG, TXT, ZIP</p>
              </div>
            </div>
          </div>

          {serverError ? (
            <p className="mt-4 text-sm text-red-300">{serverError}</p>
          ) : null}
        </form>
      ) : null}
    </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-white/10 bg-slate-800/50">
        ...
        <div className="grid grid-cols-1 divide-y divide-slate-200 dark:divide-white/5">
          {loading ? (
            <div className="p-4 text-sm text-slate-400">Carregando despesas...</div>
            ...
            filteredExpenses.slice(0, 10).map((expense) => (
              <div key={expense.id} className="flex flex-col gap-2 p-4 md:flex-row md:items-center md:justify-between">
                <div className="flex-1">
                  ...
                  <p className="text-base font-semibold text-white">{expense.category}</p>
                  <p className="text-xs text-slate-300">
      ...
      {isFormOpen ? (
        ...
        >
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-2">
            <div>
              <label className="text-sm font-medium text-slate-200" htmlFor="expenseDate">
                Data
              </label>
              <input
                id="expenseDate"
              ...
              />
              {errors.expenseDate ? (
                <p className="mt-1 text-xs text-red-300">{errors.expenseDate.message}</p>
              ) : null}
            </div>
            <div>
            ...
            <div>
              ...
              />
              {errors.amount ? (
                <p className="mt-1 text-xs text-red-300">{errors.amount.message}</p>
              ) : null}
            </div>
            <div>
              <label className="text-sm font-medium text-slate-200" htmlFor="paidById">
                Pago por
              </label>
              <select
                id="paidById"
            ...
            <div className="md:col-span-2">
              <label className="text-sm font-medium text-slate-200" htmlFor="flightId">
            ...
            <div className="md:col-span-2">
              <label className="text-sm font-medium text-slate-200" htmlFor="receipt">
                Comprovante
              </label>
              <input
                id="receipt"
